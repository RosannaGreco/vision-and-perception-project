...
def anomaly_classification(model):
    ...
    dataset = MuraDataset(csv_file='/home/rosanna/Scrivania/visiope/project/MURA_project/HUMEROUS_ANOMALIES/humerus_anomalies_final.csv', transform=transforms.ToTensor(), device=device, img_size= 64)
