...
def anomaly_classification(model):
    # data loading
#TODO: change the paths here
    train_set = MuraDataset(csv_file='/home/rosanna/Scrivania/visiope/project/MURA_project/MURA-v1.1/train_anomalies.csv', transform=transforms.ToTensor(), device=device, img_size= 64)
    test_set = MuraDataset(csv_file='/home/rosanna/Scrivania/visiope/project/MURA_project/MURA-v1.1/valid_anomalies.csv', transform=transforms.ToTensor(), device=device, img_size= 64)
