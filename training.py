...
parser.add_argument('-first', '--first', default='f', help='train of first classificator')
parser.add_argument('-second', '--second', default='f', help='train of second classificator')
parser.add_argument('-third', '--third', default='f', help='train of third classificator')
