...
csv2 = '/home/rosanna/Scrivania/visiope/project/MURA_project/train_fractures2.csv'
f2 = open(csv2, 'w')
writer = csv.writer(f2)


#open the first csv and modify images
with open('/home/rosanna/Scrivania/visiope/project/MURA_project/train_fractures.csv') as f1:
...
#concatenate csvs
file1 = open('/home/rosanna/Scrivania/visiope/project/MURA_project/train_fractures1.csv', "a") #file containing all paths and labels
file2 = open('/home/rosanna/Scrivania/visiope/project/MURA_project/train_fractures2.csv', "r") #f2
